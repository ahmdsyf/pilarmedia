<x-app-layout>
            ...
            $(document).ready(function() {
                ...
                var t = $('#sales_table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'SalesAmount', name: 'SalesAmount' },
    ...
    <div class="card px-5 py-4">
        ...
        {{-- Awal Table --}}
        <table class="table table-striped table-bordered table-sm nowrap" style="width:100%" id="sales_table">
            <thead>
                <tr>
